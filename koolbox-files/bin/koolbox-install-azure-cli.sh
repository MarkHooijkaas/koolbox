...
: ${KOOLBOX_INSTALL_AZURE_CLI_USING_APT:=${KOOLBOX_APT_AVAILABLE:-false}}

function koolbox-install-azure-cli() {
    if ${KOOLBOX_INSTALL_AZURE_CLI_USING_APT}; then
        echo installing azure-cli using apt
        #koolbox-install-azure-cli-using-apt
    else
        echo installing azure-cli using script
        #koolbox-install-azure-cli-using-script
    fi
}

function koolbox-install-azure-cli-using-apt() {
...
function koolbox-install-azure-cli-using-script() {
